...
PlantSimEngine.outputs_(::BunchHarvest) = (biomass_bunch_harvested=0.0, biomass_stalk_harvested=0.0, biomass_fruit_harvested=0.0, is_harvested=false, biomass_bunch_harvested_cum=0.0, litter=0.0)
